...
@section('title', __('nomenclature.client_create'))

@section('content')
<div class="container">
    <h1>{{ __('nomenclature.client_create') }}</h1>
    <a href="{{route('nomenclature.client.index')}}">{{__('nomenclature.clients')}}</a>
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('nomenclature.client_create') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('nomenclature.client.store') }}">
                        @csrf
